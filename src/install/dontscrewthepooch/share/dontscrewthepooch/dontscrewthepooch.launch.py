...
def generate_launch_description():
    ...
    static_tf2_base_to_lidar = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        arguments=['0', '0', '0.5', '0', '0', '0', 'base_link', 'nav2_experimental_0/lidar_link/lidar_depth'],
        parameters=[
            {'use_sim_time': True}
        ],
    )
    ...
    static_tf2_lidar_to_lidar_sensor = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        arguments=['0', '0', '0', '0', '0', '0', 'lidar_link', 'nav2_experimental_0/lidar_link/lidar_depth'],
        parameters=[
            {'use_sim_time': True}
        ],
    )
